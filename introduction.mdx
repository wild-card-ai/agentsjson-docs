---
title: 'Introduction'
description: 'Learn about agents.json - an open source specification for API and agent interactions'
---

Agents.json is an open source specification that formally describes contracts for API and agent interactions, built on top of the OpenAPI standard.

<img src="/agentsjson-white-blackbackground.png" alt="Agents.json Logo" />

## Motivations

APIs are designed for databases, not LLMs. Each developer building integrations for AI agents writes boilerplate, experiments with system prompts, optimizes tool definitions, and parses responses into vector stores - all for the same API.
